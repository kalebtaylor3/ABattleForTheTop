...
namespace BFTT.Abilities
{
    ...
    {    
        ...
        public float climbSpeedMultiplier = 1.0f; // Add this line
        [Header("Foot Casting")]
            ...
            if (HasCurrentLedge())
            {
                ...
                if (_context.CurrentClimbState == _context.Idle)
                {
                    ...
                    (_localCoordMove.x < 0 && _stopLeftShimmy))
                        ...
                        _animator.SetFloat("Horizontal", _localCoordMove.x * climbSpeedMultiplier, 0.1f, Time.deltaTime); // Apply the speed multiplier here
                }
                else
                {
                    _animator.SetFloat("Horizontal", 0);
                ...
                _animator.SetFloat("Vertical", _localCoordMove.y * climbSpeedMultiplier, 0.1f, Time.deltaTime); // Apply the speed multiplier here
